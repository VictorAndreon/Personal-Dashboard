    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            <div class="grid grid-cols-4 gap-6">
                <x-dashboard-card 
                    :value='$monthlySummary["todayBalance"]["value"]' 
                    :variation='$monthlySummary["todayBalance"]["variation"]' 
                    title='Saldo Atual'/>

                <x-dashboard-card 
                    :value='$monthlySummary["monthlyIncome"]["value"]' 
                    :variation='$monthlySummary["monthlyIncome"]["variation"]' 
                    title='Receitas do Mês'/>

                <x-dashboard-card 
                    :value='$monthlySummary["monthlyExpense"]["value"]' 
                    :variation='$monthlySummary["monthlyExpense"]["variation"]' 
                    title='Despesas do Mês'/>

                <x-dashboard-card 
                    :value='$monthlySummary["topCategory"]["value"]' 
                    :category='$category' 
