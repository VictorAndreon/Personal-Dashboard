            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <div class="py-1">
                               <x-dropdown-link :href="route('financeiro.index', ['tipo_movimentacao' => 'entrada'])" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-none">
                                    {{ __('Entradas') }}
                                </x-dropdown-link>
                            </div>
                            <div class="py-1">
